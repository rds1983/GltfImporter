...
namespace Microsoft.Xna.Framework.Content.Pipeline
{
	...
	{
		readonly Dictionary<string, TextureContent> _textures = new Dictionary<string, TextureContent>();

		/// <summary>
		/// Gets the texture collection of the material.
		/// </summary>
		/// <value>Collection of textures used by the material.</value>
		public Dictionary<string, TextureContent> Textures { get { return _textures; } }
		...
		protected TextureContent GetTexture(string key)
		{
		...
		protected void SetTexture(string key, TextureContent value)
		{
			if (value != null)
				_textures[key] = value;
			else
